...
public interface IAdminDepartmentBiz {
	 ...
	 * @return	满足条件的组织结构列表	{@link com.crm.domain.ws.hr.Department }
	 */
	 ...
	 * 查询组织结构信息
	 * @param code	组织结构编码
	 * @return	组织结构信息	{@link com.crm.domain.ws.hr.Department }
	 */
	...
	/**
	 * 添加组织结构信息			
	 * @param department	组织结构信息 {@link com.crm.domain.ws.hr.Department }
